...
pacstrap /mnt base linux linux-firmware linux-headers bash-completion grub nano unzip wget  vim networkmanager sddm xorg plasma kde-applications openssh
...
mv /root/script/config_new_system.sh /mnt/root/script

echo "Congrat!!!
please, eneter command 'arch-chroot and launch new downloaded script'"
